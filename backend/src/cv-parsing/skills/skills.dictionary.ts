...
export const SKILLS_DICTIONARY: string[] = [
  ...
  // Frontend
  'React', 'Angular', 'Vue', 'Vue.js', 'Next.js', 'Svelte',
  'HTML', 'HTML5', 'CSS', 'CSS3', 'Sass', 'Tailwind', 'Tailwind CSS',
  'Bootstrap', 'jQuery', 'Redux', 'Webpack', 'Vite',

  // Backend
  'Node.js', 'NestJS', 'Express', 'Express.js', 'Spring', 'Spring Boot',
  '.NET', 'ASP.NET', 'Django', 'Flask', 'FastAPI', 'Laravel', 'Ruby on Rails',
  ...
  'SQLite', 'DynamoDB', 'Cassandra', 'Elasticsearch', 'SQL', 'NoSQL',
  ...
  'Pandas', 'NumPy', 'Data Analysis', 'Data Science', 'Power BI',
  'Tableau', 'ETL', 'Apache Spark', 'Hadoop',

  // Project Management Tools
  'Jira', 'Confluence', 'Trello', 'Asana', 'Monday.com',

  // Design
  'Figma', 'Adobe XD', 'Sketch', 'UI/UX Design', 'Photoshop',
  ...
  'Stakeholder Management', 'Project Management', 'Time Management',
  'Critical Thinking', 'Mentoring', 'Public Speaking',

  // Business / Domain
  'Business Analysis', 'Requirements Gathering', 'Process Improvement',
  'Financial Modelling', 'Risk Management', 'Compliance',
];
