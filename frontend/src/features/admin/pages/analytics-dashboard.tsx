    ...
    return (
        <div className="flex min-h-screen" style={{ backgroundColor: "var(--color-surface)" }}>
            ...
            <div className="min-w-0 flex-1 flex flex-col min-h-screen overflow-hidden">
                <header
                    className="sticky top-0 z-20 flex min-h-[90px] shrink-0 flex-wrap items-center justify-between gap-3 border-b bg-white pl-16 pr-4 py-4 sm:px-6 lg:px-10"
                ...
                <main className="flex-1 overflow-y-auto ">
                    <div className="mx-auto flex w-full max-w-[1600px] flex-col gap-8 px-4 pb-12 pt-6 sm:px-6 lg:px-10" >
                        {error && (
