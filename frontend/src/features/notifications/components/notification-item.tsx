...
const iconStyles ={
    read:{icon: FolderDot, bgColour: "#EDE9FE", colour: "#7C3AED"},
    unread:{icon:FolderOpenDot,bgColour: "#F1F5F9", colour: "#64748B"},
    archived:{icon: Archive , bgColour: "#F1F5F9", colour:"64748B"}
}satisfies Record<NotificationItemProp["status"],notificationIcon>;
...
export default function NotificationItem({id,title,body,createdAt,link,status,checked,onToggle}:NotificationItemProp){
