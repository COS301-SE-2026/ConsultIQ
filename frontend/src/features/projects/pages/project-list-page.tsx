...
const mockProjects: readonly Project[] = [
  {
    ...
    clientName: "Shoprite",
    description: "Develop a responsive web-based dashboard for retail analytics and inventory tracking.",
    teamSize: 6,
    allocation: 80,
    budget: 30000,
  ...
  },
  {
    ...
    projectName: "Mobile Banking App Enhancement",
    clientName: "FNB",
    description: "Upgrade banking features with biometric login and push notifications.",
    teamSize: 10,
    allocation: 100,
    budget: 100000,
  ...
  },
  {
    ...
    projectName: "AI-Powered Recruitment Platform",
    clientName: "ConsultIQ",
    description: "Develop an AI platform to match consultants to projects based on skills and experience.",
    teamSize: 8,
    allocation: 70,
    budget: 500000,
  ...
  },
  {
    ...
    clientName: "Takealot",
    description: "Redesign the e-commerce website for improved user experience and mobile responsiveness.",
    teamSize: 5,
    allocation: 60,
    budget: 75000,
  ...
  },
  {
    ...
    description: "Migrate on-premises applications to AWS cloud infrastructure for improved scalability.",
    teamSize: 12,
    allocation: 90,
    budget: 200000,
  ...
  },
  {
    ...
    description: "Implement a data warehouse solution for centralized reporting and analytics.",
    teamSize: 7,
    allocation: 75,
    budget: 120000,
  ...
  },
  {
    ...
    description: "Conduct a comprehensive cybersecurity assessment and provide recommendations for improvement.",
    teamSize: 4,
    allocation: 50,
    budget: 40000,
...
export default function ProjectListPage() {
  ...
  const filteredProjects = useMemo(() => {
    return mockProjects.filter((project) => {
      ...
      if (budgetFilter === "medium") matchesBudget = project.budget >= 50000 && project.budget <= 200000;
      if (budgetFilter === "large") matchesBudget = project.budget > 200000;
      if (budgetFilter === "all") matchesBudget = true;

      let matchesTeamSize = true;
      if (teamSizeFilter === "small") matchesTeamSize = project.teamSize <= 5;
      if (teamSizeFilter === "medium") matchesTeamSize = project.teamSize >= 6 && project.teamSize <= 10;
      if (teamSizeFilter === "large") matchesTeamSize = project.teamSize > 10;
      if (teamSizeFilter === "all") matchesTeamSize = true;

      let matchesLocation = true;
      if (locationFilter) {
        matchesLocation =
          project.location.province.toLowerCase().replace(/\s/g, "-") === locationFilter;
      }
      if (locationFilter === "all") matchesLocation = true;
